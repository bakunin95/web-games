...
- **Create VFX:** header button `#create-vfx-btn` (and the panel "Create VFX" folder) spawns randomized Fire / Smoke / Sparks instances into `runtimes`. Templates are `CREATABLE_EFFECTS` in `src/effects/index.ts`.
